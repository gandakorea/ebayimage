...
$velosterEngine='(?i)(1591cc|1\.6L).*Petrol'
$products=@(
 [pscustomobject]@{itemId='803e5cdb-198f-4bfd-a509-b12e64bb3bf0';reference='324276786720';part='79110-2V000';compactPart='791102V000';categoryId='262156';usd='69.41';shipping='7day normal';title='⭐Genuine 791102V000 Hood Hinge Left For Hyundai Veloster 2012-2017';partWords='hood hinge left';usStores=@('20622051012');auStores=@('/Hyundai/Veloster');auTargets=@(
   @{make='Hyundai';model='Veloster';minYear=2012;maxYear=2017;enginePattern=$velosterEngine})},
 [pscustomobject]@{itemId='ff785ba4-80cb-4afe-9d41-01e79cf23319';reference='325583871695';part='79110-2V000_79120-2V000';compactPart='791102V000 791202V000';categoryId='262156';usd='122.35';shipping='7day fast';title='⭐Genuine Hood Hinges Left Right 2EA For Hyundai Veloster 2012-2017';partWords='hood hinges left and right set';usStores=@('20622051012');auStores=@('/Hyundai/Veloster');auTargets=@(
   @{make='Hyundai';model='Veloster';minYear=2012;maxYear=2017;enginePattern=$velosterEngine})}
)
