...
$batchRoot = Join-Path $projectRoot '작업중\batch-20260910-agent1\us-publish'
$sourceRoot = Join-Path $projectRoot '작업중\batch-20260910-agent1'
$templateSourceRoot = Join-Path $projectRoot '작업중\batch-20260910-agent1'
...
$products = @(
    [pscustomobject]@{ reference='234975153511'; key='92101-F2400_92102-F2400'; part='92101-F2400 92102-F2400'; compactPart='92101F2400 92102F2400'; spacedPart='92101 F2400 92102 F2400'; price='2805.88'; shipping='fast'; title='⭐Genuine Hid Drl Headlight Left Right 2EA For Hyundai Elantra Sport 2018'; partWords='HID DRL headlight left and right set'; store1='45702642012'; store2='0'; countryOrigin='Korea, Republic of' },
    [pscustomobject]@{ reference='234975147676'; key='92102-F2400'; part='92102-F2400'; compactPart='92102F2400'; spacedPart='92102 F2400'; price='1498.82'; shipping='fast'; title='⭐Genuine 92102F2400 Hid Drl Headlight Right For Hyundai Elantra Sport 2018'; partWords='HID DRL headlight right'; store1='45702642012'; store2='0'; countryOrigin='Korea, Republic of' }
)
