...
$batchRoot = Join-Path $projectRoot '작업중\batch-20260909-agent3\us-publish'
$sourceRoot = Join-Path $projectRoot '작업중\batch-20260909-agent3'
$templateSourceRoot = Join-Path $projectRoot '작업중\batch-20260909-us'
...
function New-Description([string]$Template, [string]$TemplateTitle, $Product) {
    ...
    $value = $value.Replace('935703s000ry', $Product.part.Replace('-',''))
...
$products = @(
    [pscustomobject]@{ reference='334835096174'; part='92101-F2400'; price='1498.82'; shipping='fast'; title='⭐Genuine 92101F2400 Hid Drl Headlight Left Driver For Hyundai Elantra Sport 2018'; partWords='HID DRL headlight left driver'; store1='45702642012'; store2='0'; countryOrigin='Korea, Republic of' }
)
