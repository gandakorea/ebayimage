...
$packages = @(Get-ChildItem -LiteralPath $packageRoot -Filter '*.json' -File | Where-Object { $_.BaseName -notmatch '-au-audit$|^4897760a-7812-4269-a947-d49aba83cb25$' } | Sort-Object Name | ForEach-Object { Get-Content -Raw -LiteralPath $_.FullName | ConvertFrom-Json })
