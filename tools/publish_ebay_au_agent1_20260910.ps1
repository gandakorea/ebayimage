...
$batchRoot = Join-Path $projectRoot '작업중\australia\batch-20260910-agent1'
$usDescriptionRoot = Join-Path $projectRoot '작업중\batch-20260910-agent1\us-publish'
...
$products = @(
    [pscustomobject]@{
        key='92101-F2400_92102-F2400'; part='92101-F2400 92102-F2400'; compactPart='92101F2400 92102F2400'; spacedPart='92101 F2400 92102 F2400'; sku='92101-F2400_92102-F2400-AU-20260910'; categoryId='33710'; price='3883.34'; usd='2805.88'; exchangeRate='1.384'; shipping='fast';
        title='⭐Genuine Hid Drl Headlight Left Right 2EA For Hyundai Elantra Sport 2018'; usTitle='⭐Genuine Hid Drl Headlight Left Right 2EA For Hyundai Elantra Sport 2018'; type='Headlight Assembly'; partWords='HID DRL headlight left and right set'; countryOrigin='Korea, Republic of';
    ...
    [pscustomobject]@{
        key='92102-F2400'; part='92102-F2400'; compactPart='92102F2400'; spacedPart='92102 F2400'; sku='92102-F2400-AU-20260910'; categoryId='33710'; price='2074.37'; usd='1498.82'; exchangeRate='1.384'; shipping='fast';
        title='⭐Genuine 92102F2400 Hid Drl Headlight Right For Hyundai Elantra Sport 2018'; usTitle='⭐Genuine 92102F2400 Hid Drl Headlight Right For Hyundai Elantra Sport 2018'; type='Headlight Assembly'; partWords='HID DRL headlight right'; countryOrigin='Korea, Republic of';
        stores=@('/Hyundai/Elantra');
        compatibilityTargets=@(
            @{make='Hyundai';model='Elantra';minYear=2018;maxYear=2018;enginePattern='(?i)(1\.6L|1591cc).*Petrol'}
        )
